 ...
 */
final class Version20260521080208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE build (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, dimensions_x INT DEFAULT NULL, dimensions_y INT DEFAULT NULL, dimensions_z INT DEFAULT NULL, difficulty VARCHAR(255) NOT NULL, time_estimated_min INT NOT NULL, game_version VARCHAR(255) NOT NULL, game_mode VARCHAR(255) NOT NULL, visibility VARCHAR(255) NOT NULL, hidden_reason TEXT DEFAULT NULL, hidden_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, views_count INT DEFAULT 0 NOT NULL, likes_count INT DEFAULT 0 NOT NULL, saves_count INT DEFAULT 0 NOT NULL, downloads_count INT DEFAULT 0 NOT NULL, ratings_count INT DEFAULT 0 NOT NULL, rating_avg NUMERIC(3, 2) DEFAULT \'0.00\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, modded BOOLEAN NOT NULL, author_id INT NOT NULL, hidden_by_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE build_asset (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, type VARCHAR(255) NOT NULL, url TEXT NOT NULL, filename VARCHAR(255) NOT NULL, size_bytes INT NOT NULL, downloads_count INT DEFAULT 0 NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, build_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_42772D5717C13F8B ON build_asset (build_id)');
        $this->addSql('CREATE TABLE build_category (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, build_id INT NOT NULL, category_id INT NOT NULL, PRIMARY KEY (build_id, category_id))');
        ...
        $this->addSql('CREATE TABLE build_image (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, url TEXT NOT NULL, alt VARCHAR(255) DEFAULT NULL, sort_order INT DEFAULT 0 NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, build_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_85E5735417C13F8B ON build_image (build_id)');
        $this->addSql('CREATE TABLE build_like (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, build_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY (build_id, user_id))');
        ...
        $this->addSql('CREATE TABLE build_material (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(255) NOT NULL, quantity INT NOT NULL, color VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, build_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_989D2FE317C13F8B ON build_material (build_id)');
        $this->addSql('CREATE TABLE build_rating (rating INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, build_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY (build_id, user_id))');
        ...
        $this->addSql('CREATE TABLE build_save (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, build_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY (build_id, user_id))');
        ...
        $this->addSql('CREATE TABLE build_tag (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, build_id INT NOT NULL, tag_id INT NOT NULL, PRIMARY KEY (build_id, tag_id))');
        ...
        $this->addSql('CREATE TABLE category (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, name_fr VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CATEGORY_NAME ON category (name)');
        $this->addSql('CREATE TABLE comment (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, deleted_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, build_id INT NOT NULL, author_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_9474526C17C13F8B ON comment (build_id)');
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE TABLE moderation_action (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, target_type VARCHAR(255) NOT NULL, action VARCHAR(255) NOT NULL, reason TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, moderator_id INT NOT NULL, build_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE notification (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, type VARCHAR(255) NOT NULL, message TEXT NOT NULL, read_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, recipient_id INT NOT NULL, actor_id INT NOT NULL, build_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE report (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, target_type VARCHAR(255) NOT NULL, reason_code VARCHAR(255) NOT NULL, message TEXT NOT NULL, status VARCHAR(255) NOT NULL, handled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, reporter_id INT NOT NULL, build_id INT DEFAULT NULL, comment_id INT DEFAULT NULL, handled_by_id INT DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE role (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, code VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_ROLE_CODE ON role (code)');
        $this->addSql('CREATE TABLE tag (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_TAG_NAME ON tag (name)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_TAG_SLUG ON tag (slug)');
        $this->addSql('CREATE TABLE "user" (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, username VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, avatar_url TEXT DEFAULT NULL, bio TEXT DEFAULT NULL, is_active BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, role_id INT NOT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_8D93D649D60322AC ON "user" (role_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME ON "user" (username)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_USER_EMAIL ON "user" (email)');
        $this->addSql('CREATE TABLE user_follow (created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, follower_id INT NOT NULL, following_id INT NOT NULL, PRIMARY KEY (follower_id, following_id))');
